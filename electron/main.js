...
// ★ identidade do app na barra de tarefas do Windows
if (process.platform === "win32") app.setAppUserModelId("com.eyegate.school");
const ICONE = path.join(ROOT, "img", process.platform === "win32" ? "logo.ico" : "logo.png");
